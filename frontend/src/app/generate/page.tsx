          ...
          <>
            ...
            <div className={styles.artifactContent}>
              <div className="text-center text-gray-500 py-8">
                <p className="text-lg font-semibold mb-2">Document Ready</p>
                <p>Type: <strong>{generatedDocType?.toUpperCase()}</strong></p>
                <p className="text-sm mt-2">Click the Download button to save your document</p>
              </div>
            </div>
          </>
        ) : (
          <div className={styles.artifactArea} style={{ display: "flex", alignItems: "center", justifyContent: "center", color: "#888" }}>
